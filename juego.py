...
import sys
import random
from carnes import crear_carne_aleatoria, actualizar_logica_carnes, voltear_carne
...
def iniciar_juego():
    ...
    slots_preparacion = [
        {"x": 250, "y": 100, "ocupado": False},
        {"x": 500, "y": 100, "ocupado": False},
        {"x": 750, "y": 100, "ocupado": False},
        {"x": 1000, "y": 100, "ocupado": False}
    ]
    
    # --- CONFIGURACIÓN DE LA PARRILLA ---
    puestos_parrilla = [
        {"x": 200, "y": 550, "ocupado": False},
        {"x": 450, "y": 550, "ocupado": False},
        {"x": 700, "y": 550, "ocupado": False},
        {"x": 950, "y": 550, "ocupado": False}
    ]
    ...
    timer_generacion = random.uniform(5.0, 10.0)
    ...
    while ejecutando:
        ...
        # Dibujamos la zona inferior de la parrilla
        pygame.draw.rect(pantalla, (25, 25, 25), (50, 400, 1100, 450), border_radius=15)
        ...
        for carne in carnes_activas:
            if carne["estado_crudo"]:
                ...
                pygame.draw.rect(pantalla, (35, 35, 35), carne["rect"])
            
            # Barras de cocción (solo visibles en la parrilla)
            if carne["ubicacion"] == "parrilla" and carne["puntaje_coccion"] > 0:
                ...
                pygame.draw.rect(pantalla, (80, 80, 80), (x_barra, y_barra, ancho_total_barra, 8))
